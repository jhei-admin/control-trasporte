...
ADMIN_LATEST_VERSION_CODE = int(os.getenv("ADMIN_LATEST_VERSION_CODE", "0"))
ADMIN_LATEST_VERSION_NAME = os.getenv("ADMIN_LATEST_VERSION_NAME", "").strip()
ADMIN_UPDATE_FORCE = env_bool("ADMIN_UPDATE_FORCE", False)
ADMIN_UPDATE_CHANGELOG = os.getenv("ADMIN_UPDATE_CHANGELOG", "").strip()
ADMIN_UPDATE_PUBLISHED_AT = os.getenv("ADMIN_UPDATE_PUBLISHED_AT", "").strip()
